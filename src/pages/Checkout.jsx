              ...
              <div className="pt-4 border-t border-stans-offwhite">
                <label className="flex items-start gap-3 cursor-pointer group">
                  ...
                  <span className="text-[11px] text-stans-slate/80 leading-snug group-hover:text-stans-navy transition-colors">
                    I agree to be contacted by ROLLAND SPACES PRIVATE LIMITED regarding product enquiries, order updates, offers and related services through Call, SMS, WhatsApp or Email.
                  </span>
                </label>
              </div>
            </div>
