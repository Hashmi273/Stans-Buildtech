      ...
      <div className="pt-1">
        <label className="flex items-start gap-3 cursor-pointer group">
          ...
          <span className="text-[11px] text-stans-slate/80 leading-snug group-hover:text-stans-navy transition-colors">
            I consent to <strong>Stans Buildtech</strong> contacting me via Call, SMS, WhatsApp, and Email regarding project updates and offers. I understand I can withdraw consent anytime.
          </span>
        </label>
      </div>
